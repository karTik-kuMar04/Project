...
export default async function IndusValleySubpage({
  ...
  const nextSubpage =
    subpageIndex < indusValleySubpages.length - 1
      ? indusValleySubpages[subpageIndex + 1]
      : null;
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-6xl">
        ...
        >
          ...
          <Link href="/indus-valley" className="hover:text-[#ebd6bd] transition-colors">
            Indus Valley
          </Link>
          <span className="text-stone-700">/</span>
        ...
        <div className="mt-24 border-t border-[#a38560]/20 pt-10 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          {nextSubpage ? (
            <Link
              href={`/indus-valley/${nextSubpage.id}`}
