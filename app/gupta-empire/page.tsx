...
export const metadata: Metadata = {
  title: "Gupta Empire | Archives",
  description: "Examine the registry of the Gupta Empire, exploring its foundation, golden age, science, administration, trade, and eventual decline.",
};
...
export default function GuptaEmpireHub() {
  return (
    <main
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        <div className="mb-20 text-center max-w-3xl mx-auto">
          ...
          >
            By the early 4th century CE, the political fragmentation that followed the Mauryan collapse had given way to a new power rising out of Magadha. Within a century, the Gupta dynasty controlled most of northern India, and its court became a byword for everything historians now associate with classical India: Sanskrit poetry, advances in mathematics and astronomy, rust-resistant ironwork, and temple architecture that would set the template for centuries to come. Later writers called this the “Golden Age” — a label modern scholarship treats with some caution, but one that still captures something real. Explore six facets of Gupta India below.
          </p>
        </div>

        <EraChapterStack title="The Gupta Empire" chapters={guptaSubpages} era="gupta-empire"/>
