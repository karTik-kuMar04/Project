...
export default async function PallavaDynastySubpage({
  ...
  const nextSubpage =
    subpageIndex < pallavaSubpages.length - 1
      ? pallavaSubpages[subpageIndex + 1]
      : null;
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-6xl">
        ...
        >
          ...
          <Link href="/pallava-dynasty" className="hover:text-[#ebd6bd] transition-colors">
            Pallava Dynasty
          </Link>
          <span className="text-stone-700">/</span>
        ...
        {/* Dravidian Architectural Glossary on Cities & Architecture pages */}
        ...
        {/* Handover Alert on Rulers page */}
        {slug === "rulers" && (
          <div className="mb-16 bg-amber-950/20 border border-[#a38560]/30 rounded-xl p-6 relative overflow-hidden backdrop-blur-md">
            <span
              style={{ fontFamily: "var(--font-cinzel), serif" }}
            ...
            <p
              style={{ fontFamily: "var(--font-cormorant), serif" }}
              className="text-stone-300 leading-relaxed text-sm italic mb-4"
            >
            ...
            <Link
              href="/chola-empire/rise"
              style={{ fontFamily: "var(--font-cinzel), serif" }}
              className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-[#d16c3d] hover:text-[#ebd6bd] transition-colors"
            >
              Explore Chola Rise
              <span>→</span>
            </Link>
        ...
        <div className="mt-24 border-t border-[#a38560]/20 pt-10 flex flex-col md:flex-row justify-between items-center gap-6">
          {slug === "origins" ? (
            <Link
              href="/gupta-empire/religion-and-decline"
              style={{ fontFamily: "var(--font-cinzel), serif" }}
            ...
            >
              ...
              Previous Era: End of Gupta Empire
            </Link>
          ) : (
            <Link
          ...
          {nextSubpage ? (
            <Link
              href={`/pallava-dynasty/${nextSubpage.id}`}
