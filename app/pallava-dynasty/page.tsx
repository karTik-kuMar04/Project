...
export const metadata: Metadata = {
  title: "Pallava Dynasty | Archives",
  description: "Examine the registry of the Pallava Dynasty, exploring its origins, capitals, architecture, rulers, military, and religious legacy.",
};
...
export default function PallavaDynastyHub() {
  return (
    <main
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        <div className="mb-20 text-center max-w-3xl mx-auto">
          ...
          >
            Between the 3rd and 9th centuries CE, a dynasty rose in the Tamil South that left two of the most extraordinary architectural legacies on earth. At Kanchipuram they built temples of sandstone that defined the Dravidian form. At Mahabalipuram they carved entire shrine-complexes from coastal boulders and built the first freestanding stone temple on the subcontinent’s eastern shore. They fought the Chalukyas, sent navies to Sri Lanka, and presided over the bhakti revolution that reshaped Tamil religious life. The Pallavas did not just rule southern India — they gave it its architectural grammar. Explore six facets of their world below.
          </p>
        </div>

        <EraChapterStack title="The Pallava Dynasty" chapters={pallavaSubpages} era="pallava-dynasty" />
      </div>
    </main>
  );
}
